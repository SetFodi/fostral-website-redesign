            ...
            <main className={styles.main}>
                ...
                <section className={styles.header}>
                    <div className={styles.container}>
                        ...
                        <h1 className={styles.title}>Engineering Business Software</h1>
                ...
                <section className={styles.storySection}>
                    <div className={styles.container}>
                        <div className={styles.twoColGrid}>
                            ...
                            <div className={styles.textBlock}>
                                <h2>Experience Across Industries and Regions</h2>
                ...
                <section className={styles.foundersSection}>
                    <div className={styles.container}>
                        <div className={styles.sectionCenterHeader}>
                            ...
                            <h2>Founders</h2>
                            <p style={{ marginTop: '1rem', color: 'var(--gray-600)' }}>Fostral was founded by professionals combining backgrounds in business operations and enterprise software engineering.</p>
                        </div>
                        ...
                        <p style={{ textAlign: 'center', marginTop: '3rem', color: 'var(--gray-600)' }}>
                            Together they bring experience across business systems architecture, operational process design, and international project delivery.
                        </p>
                    </div>
                </section>
                    ...
                    <div className={styles.container}>
                        <div className={styles.philosophyBox}>
                            <div className={styles.philosophyGrid}>
                                ...
                                <div className={styles.philBlock}>
                                    <div className={styles.philIcon}>⚡</div>
                                    <h3>How We Choose the Right Platform</h3>
