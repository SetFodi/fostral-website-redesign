...
const solutionsData = [
    {
        ...
        items: [
            {
                id: 'cfo-consolidator',
                name: 'CFO Consolidator',
                desc: 'Cross-entity financial consolidation, multi-company transaction synchronisation, structured approval workflows, and consistent tax reporting.'
            },
            {
                id: 'mrp-warehouse',
                name: 'MRP & Warehouse Management',
                desc: 'Production planning, bill of materials, inventory tracking, and demand forecasting for greater operational control.'
            },
            {
                id: 'sales-order',
                name: 'Sales & Order Management',
                desc: 'Unified framework for the entire order lifecycle – quotations, approvals, contracts, fulfilment, and invoicing.'
            },
            {
                id: 'crm-b2b',
                name: 'CRM for B2B',
                desc: 'Manage opportunity pipelines, customer interactions, sales forecasting, and deal management.'
            },
            {
                id: 'crm-marketing',
                name: 'CRM & Marketing for B2C',
                desc: 'Orchestrate communication campaigns, marketing automation, lead generation, and customer lifecycle tracking.'
            },
            {
                id: 'ecommerce-loyalty',
                name: 'eCommerce & Customer Loyalty',
                desc: 'Online store management, product catalogue synchronisation, order fulfilment, and loyalty programmes.'
            },
            {
                id: 'hcm-payroll',
                name: 'HCM & Payroll',
                desc: 'Manage employees, contracts, leave management, and payroll processes in one structured environment.'
            },
            {
                id: 'tax-reporting',
                name: 'Tax Reporting Management',
                desc: 'Automated transaction records, approval flows, and reporting frameworks for tax compliance.'
            },
            {
                id: 'tender-supplier',
                name: 'Tender & Supplier Management',
                desc: 'Tender coordination, vendor comparison, and contract lifecycle visibility for structured procurement.'
            },
            {
                id: 'iso-management',
                name: 'ISO Management',
                desc: 'Documentation control, quality procedures, audit events, and compliance monitoring.'
            }
        ]
    },
    {
        ...
        items: [
            {
                id: 'unique-workflows',
                name: 'Unique Workflows',
                desc: 'Custom workflows and specialised modules for industries like maritime logistics, oil & gas operations, heavy manufacturing, and cargo transportation.'
            },
            {
                id: 'rpa-connectors',
                name: 'RPA Connectors',
                desc: 'Robotic process automation algorithms allowing software to interact with external systems that lack standard APIs.'
            },
            {
                id: 'ai-extensions',
                name: 'AI Extensions',
                desc: 'Intelligent automation to recognise document data, extract invoice info, process scanned materials, and automate decisions.'
            }
        ]
    },
    {
        ...
        items: [
            {
                id: 'sap-s4hana-public',
                name: 'SAP S/4HANA Cloud Public',
                desc: 'Modern enterprise ERP delivered as a managed cloud service with rapid deployment cycles.'
            },
            {
                id: 'sap-s4hana-private',
                name: 'SAP S/4HANA Cloud Private',
                desc: 'Private cloud deployments providing greater flexibility and deeper customisation options for complex environments.'
            },
            {
                id: 'sap-data-cloud',
                name: 'SAP Business Data Cloud',
                desc: 'Built on HANA in-memory database to aggregate internal, external, and analytical data models into one trusted environment.'
            },
            {
                id: 'sap-business-ai',
                name: 'SAP Business AI',
                desc: 'Generative AI capabilities to analyse operational data, automate tasks, and assist employees with decision-making.'
            }
        ]
    },
    {
        ...
        items: [
            {
                id: 'google-collaboration',
                name: 'Collaboration Ecosystem',
                desc: 'Corporate email infrastructure, shared document governance, video meetings, and cross-team workflow coordination.'
            }
        ]
    }
];
    ...
    useEffect(() => {
        const handleHashChange = () => {
            ...
            if (targetCategory) {
                ...
                // Need a small timeout to let the tab render before scrolling to the item
                setTimeout(() => {
            ...
            <main className={styles.main}>
                ...
                <section className={styles.header}>
                    <div className={styles.container}>
                        ...
                        <h1 className={styles.title}>Digital platforms that run<br />modern businesses</h1>
                ...
                <section className={styles.closingSection}>
                    <div className={styles.container}>
                        <div className={styles.coherentBox}>
                            <h2>A Connected Digital Environment</h2>
                            <p>
